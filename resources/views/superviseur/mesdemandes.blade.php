...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <a href="#">
                <button class="btn btn-info" data-toggle="modal" data-target="#addnewleaveModal"><i class="fas fa-calendar-plus"></i>&nbsp;Ajouter une demande</button>
            </a>
            <br><br>
            <div class="card">                
...
<script>    
    ...
    function showdetails(id) {
        ...
        $.getJSON('./detailsDemandeEquipe/' + id, function(data) {            
            type = data[0].type;
            etat = data[0].etat;
            motif = data[0].motif;
            datedebut = data[0].date_debut;
            datefin = data[0].date_fin;
            heuresortie = data[0].heure_sortie;
            duree = data[0].duree;
            datereprise = data[0].date_reprise;
            heurereprise = data[0].heure_reprise;
